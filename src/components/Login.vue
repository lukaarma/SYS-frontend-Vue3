...
<span>
    ...
    <div class="field">
        ...
        <div class="control has-icons-left has-icons-right">
            ...
            <input id="passwordInput" class="input" :type="passwordVisible ? 'text' : 'password'" placeholder="password" value="">
         
            <span class="click-icon icon is-small is-right" @click="passwordVisible = !passwordVisible" data-target="passwordInput">
    ...
    <div class="field is-grouped">
        <div class="control">
            ...
            <p class="help is-danger">Username or Password is invalid</p>
        </div>
...
//     const $togglePasswordElements = document.querySelectorAll('.click-icon');

//     if ($togglePasswordElements.length) {
//         $togglePasswordElements.forEach(el => {
